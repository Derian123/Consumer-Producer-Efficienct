...
//            buffer2.clear();
            ...
            //the first 10 print statements are for the random consume, and the next 10 print statements are for the produce to shortest array
 //       }
      //  System.out.println("------------------------------------------------------------------------------------------------------------------");
 //       for(int i = 0; i < 10; i++) {
//            buffer.clear();
//            buffer2.clear();
            ...
            Buffer c = new Buffer(5, 2, 2, 20, 20, 100000000);
            c.runSimulation2();
